...
public class IS31FL3731 {
	...
	public IS31FL3731(DeviceAddress address) {
		...
		I2CDevice device1 = bus1.getDevice(DeviceAddress.AD_GND);
	 ...
	 */
	public void setBreathControl(boolean enableBreathing, int fadeOutTimeMs, int fadeInTimeMs, int extinguishTimeMs) {
	...
	public int readFrameStateRegister () {
		
		selectFunctionRegister();
		int val = i2cRead(FunctionRegister.FRAME_STATE);
